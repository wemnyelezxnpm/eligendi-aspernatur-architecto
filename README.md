...
[![Coverage Status](https://coveralls.io/repos/github/wemnyelezxnpm/eligendi-aspernatur-architecto/badge.svg)](https://coveralls.io/github/wemnyelezxnpm/eligendi-aspernatur-architecto)
[![ci](https://github.com/wemnyelezxnpm/eligendi-aspernatur-architecto/actions/workflows/ci.yml/badge.svg)](https://github.com/wemnyelezxnpm/eligendi-aspernatur-architecto/actions/workflows/ci.yml)
[![NPM Version](https://img.shields.io/npm/v/@wemnyelezxnpm/eligendi-aspernatur-architecto.svg)](https://www.npmjs.com/package/@wemnyelezxnpm/eligendi-aspernatur-architecto)
[![NPM Downloads](https://img.shields.io/npm/dm/@wemnyelezxnpm/eligendi-aspernatur-architecto.svg)](http://npm-stat.com/charts.html?package=@wemnyelezxnpm/eligendi-aspernatur-architecto)
[![jsDelivr hits (npm)](https://img.shields.io/jsdelivr/npm/hw/@wemnyelezxnpm/eligendi-aspernatur-architecto)](https://www.jsdelivr.com/package/npm/@wemnyelezxnpm/eligendi-aspernatur-architecto)
...
```
npm install @wemnyelezxnpm/eligendi-aspernatur-architecto
```
...
import { supportTransform } from "@wemnyelezxnpm/eligendi-aspernatur-architecto";
...
```js
// EXAMPLES
import { getAttribute, hasAttribute, setAttribute } from "@wemnyelezxnpm/eligendi-aspernatur-architecto";
...
```js
// EXAMPLES
import { support3DTransform } from "@wemnyelezxnpm/eligendi-aspernatur-architecto";
...
```js
// EXAMPLES
import { addClass, removeClass, hasClass } from "@wemnyelezxnpm/eligendi-aspernatur-architecto";
...
```js
// EXAMPLES
import { on, off, one, passiveHandler } from "@wemnyelezxnpm/eligendi-aspernatur-architecto";
...
```js
// EXAMPLES
import { getElementAnimationDuration } from "@wemnyelezxnpm/eligendi-aspernatur-architecto";
...
```js
// EXAMPLES
import { isArray, isHTMLElement, isElementsArray } from "@wemnyelezxnpm/eligendi-aspernatur-architecto";
...
The **_Data_** and **_Timer_** utilities have their own specifics, you might want to check the [wiki](https://github.com/wemnyelezxnpm/eligendi-aspernatur-architecto/wiki).

```js
// EXAMPLES
import { emulateTransitionEnd, distinct } from "@wemnyelezxnpm/eligendi-aspernatur-architecto";
...
```js
// EXAMPLES
import { querySelector, querySelectorAll, documentAll, matches } from "@wemnyelezxnpm/eligendi-aspernatur-architecto";
...
```js
// EXAMPLES
import { on, off, one, mouseClickEvents, touchEvents, passiveHandler } from "@wemnyelezxnpm/eligendi-aspernatur-architecto";
...
```js
// Example
import on from "@wemnyelezxnpm/eligendi-aspernatur-architecto/src/event/on";
import addClass from "@wemnyelezxnpm/eligendi-aspernatur-architecto/src/class/addClass";
import getElementById from "@wemnyelezxnpm/eligendi-aspernatur-architecto/src/selectors/getElementById";
import mouseclickEvent from "@wemnyelezxnpm/eligendi-aspernatur-architecto/src/strings/mouseclickEvent";
...
**shorty** is released under the [MIT License](https://github.com/wemnyelezxnpm/eligendi-aspernatur-architecto/blob/master/LICENSE)
